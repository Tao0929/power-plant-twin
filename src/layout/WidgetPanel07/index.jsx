...
function WidgetPanel07 (props) {
    const { title, currentName } = props;
    const CONFIG = {
        变桨系统: [
    ...
    const currentList = useMemo(() => {
        console.log('WidgetPanel07', currentName);
                    ...
                    currentList.map((item, index) => {
                        return (
                            <div className={styles.item} key={item.label+index}>
                                ...
                                <div className={styles.itemValue}>{item.value}{ item.unit}</div>
                            </div>
                        )
                    })
                }
